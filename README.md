...
| 2022.03 ~ 2022.12 | D&A 빅데이터분석학회 | 학회원 | - |
...
|[빅데이터 분석 학회] D&A|서울특별시 자치구별 학구열 분석 및 교육 사업 제안|데이터 분석 및 시각화|-|-|
|[전공] 공간데이터분석|홍대&상수 상권 분석을 통한 생존 전략|QGIS|2022.05~2022.06|-|
|[전공] 머신러닝|최고 연봉 예측 모델링 컴피티션|ML|2022.10~2022.11|-|
...
|[빅데이터 분석 학회] D&A|[가제] 3D 생성 구현|3D|2023.07~2023.11|진행중|
...
|:------:|:---:|:---:|:---:|:---:|
|[(주)피플앤커리어그룹/경력개발지원단]|Junior CoREP 7기|직무 로드맵 팀 공모전|(1위) 대상|총장상 수여|
|[SDC-통계데이터센터]|[분석활용대회] 통계데이터 분석·활용대회|데이터 분석|본선 진출||
|[DACON]|유전체 정보 품종 분류 AI 경진대회|ML|-|-|
|[(사)한국빅데이터학회/후원: CJ제일제당]|CJ 더마켓 고객 예측 알고리즘 모델링 대회|ML|본선 진출|상위 15%(63팀 중 10위)|
