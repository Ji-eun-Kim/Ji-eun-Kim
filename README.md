...
|[전공] 회귀분석|2019 국민건강영양조사 데이터를 활용한 <br> 행복결정요인 분석-수면과 월평균 가구총소득 중심으로|회귀분석|-|-|
|[전공] 빅데이터처리와시각화|따릉이 대여량에 따른 성북구 따릉이 이용 최적화 제안 <br> - Streamlit을 활용한 App 개발 |데이터 분석|-|-|
|[빅데이터 분석 학회] D&A|서울특별시 자치구별 학구열 분석 & 서울런 교육 사업|데이터 분석 <br> 및 시각화|-|-|
